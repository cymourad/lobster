...
const blogs = [
	...
	},
	{
		...
		summary:
			<ul>
				...
				<ul>
					<li><b>Model</b>: Manual Sit to Stand Adjustable Desk Riser Frame (Table Top Not Included), Black - PrimeCables®</li>
					<li><b>Online Store</b>: <a href="https://www.shopperplus.ca/" target="_blank">https://www.shopperplus.ca/</a></li>
				</ul>
			</ul>,
	...
	},
	{
		...
		summary:
			<ul>
				...
				<ul>
					<li><b>Model</b>: Nema 23 Bipolar 3Nm (425oz.in) 4.2A 57x57x114mm 4 Wires Stepper Motor CNC</li>
					<li><b>Online Store</b>: <a href="https://www.omc-stepperonline.com/" target="_blank">https://www.omc-stepperonline.com/</a></li>
				</ul>
			</ul>,
		authors: [TEAM_MEMBER_NAME.JASON],
	...
	},
	{
		...
		summary:
			<ul>
				<li>Talked about the implementation of the server around the machine vision script</li>
				<li>Daniel suggested using SQLAlchemy as the ORM instead of raw SQL requires, as well as an integration with flask RESTplus for easier API modelling.</li>
			</ul>,
		...
		summary:
			<ul>
				...
				<ul>
					...
					<li>Alec got the board and BLE module and is waiting on motor drivers to arrive</li>
				</ul>
				<li>Tasks</li>
				<ul>
					<li>Daniel to build server and expose endpoints to Hussein</li>
					<li>Hussein to build minimal app that can send BLE command (send a float)</li>
					<li>Chris to assist Hussein</li>
					<li>Alec to test BLE module and motor drivers</li>
					<li>Jason to get plywood top for desk and to 3D print missing parts based on final measurements of the desk and the motors </li>
				</ul>
			</ul>,
		authors: [TEAM_MEMBER_NAME.CHRIS, TEAM_MEMBER_NAME.DANIEL, TEAM_MEMBER_NAME.JASON, TEAM_MEMBER_NAME.ALEC, TEAM_MEMBER_NAME.HUSSEIN],
	...
	},
	{
		...
		summary:
			<ul>
				<li>Put together the Prime Cables desk frame using the provided screws</li>
			</ul>,
		authors: [TEAM_MEMBER_NAME.JASON],
	...
	},
	{
		...
		summary:
			<ul>
				...
				<ul>
					<li><b>Model</b>: Mounting Bracket for Nema 23 Stepper Motor (Geared Stepper) CNC 3D Printer</li>
					<li><b>Online Store</b>: <a href="https://www.amazon.ca/" target="_blank">https://www.amazon.ca/</a></li>
				</ul>
			</ul>,
		authors: [TEAM_MEMBER_NAME.JASON],
		date: new Date("2021-01-10"),
	...
	},
	{
		...
		summary:
			<ul>
				<li>Integrated preliminary posture tracking script made with GluonCV with the flask app</li>
				<ul>
					<li>On POST to session, the base64 image is decoded and passed into the image processing algorithm</li>
					<li>The numpy array of joint coordinates is converted into a PostureData object and stored in the DB</li>
				</ul>
				<li>Created service to calculate all the angles of the joints based on PostureData</li>
				...
				<li>Converted the relative coordinate system into absolute measurements using the user’s pre-stored height</li>
				<li>Use basic trigonometry to determine height adjustments to chair and desk based on angle deviation and joint lengths.</li>
			</ul>,
		authors: [TEAM_MEMBER_NAME.DANIEL],
	...
	},
	{
		...
		summary:
			<ul>
				...
				<li>Made obvious tweaks to incorrect mathematical approaches in the code</li>
			</ul>,
		authors: [TEAM_MEMBER_NAME.CHRIS, TEAM_MEMBER_NAME.DANIEL],
	...
	},
	{
		...
		summary:
			<ul>
				...
				<ul>
					<li><b>Model</b>: Spruce Polywood (Quantity - 2)</li>
					<li><b>Online Store</b>: <a href="https://rona.narvar.com/" target="_blank">https://rona.narvar.com/</a></li>
				</ul>
				<li>Bought a Shaft Coupler.</li>
				<ul>
					<li><b>Online Store</b>: <a href="https://www.digitmakers.ca/" target="_blank">https://www.digitmakers.ca/</a></li>
				</ul>
			</ul>,
		authors: [TEAM_MEMBER_NAME.JASON],
	...
	},
	{
		...
		summary:
			<ul>
				...
				<li>Registered domain and created ssl certs for <a href="www.posture.spottscheduler.com/" target="_blank">www.posture.spottscheduler.com/</a></li>
				<li>Used Route53 to perform DNS routing of the domain name to the EC2 instance public IP</li>
			</ul>,
		authors: [TEAM_MEMBER_NAME.DANIEL],
	...
	},
	{
		...
		summary:
			<ul>
				...
				<li>It was discovered that 3D printing the electrical part housing unit would be quite expensive.</li>
				<ul>
					<li>As an alternative, a woodshop solution was pursued and resulted in a shelving unit with the same design shape</li>
				</ul>
			</ul>,
		authors: [TEAM_MEMBER_NAME.JASON],
		date: new Date("2021-01-17"),
	...
	},
	{
		...
		summary:
			<ul>
				...
				<li>Observed the quality of connection between the shaft coupler, the motor, and the table turning rod (used to elevate the table).</li>
				<ul>
					<li>Deemed fit for use based on the snugness of the fit between the motor shaft and the coupler, and between the turning rod and the coupler</li>
				</ul>
			</ul>,
		authors: [TEAM_MEMBER_NAME.JASON],
	...
	},
	{
		...
		summary:
			<ul>
				<li>Connected the motor, motor mount, and turning rod to the table top, ultimately finalizing the first iterative prototype before any major modifications are to be made from testing the overall system.</li>
			</ul>,
		authors: [TEAM_MEMBER_NAME.JASON],
	...
	},
	{
		...
		summary:
			<ul>
				<li>Gave the table to Alec for electrical implementation and motor testing.</li>
			</ul>,
		authors: [TEAM_MEMBER_NAME.JASON],
	...
	},
	{
		...
		summary:
			<ul>
				<li>Gave the BLE module and associated hardware to Hussein for testing. According to Hussein, the app worked!</li>
			</ul>,
		...
		summary:
			<ul>
				...
				<ul>
					...
					<li>For a given user_id and session_id, the average results of the session will be returned with the outliers filtered out.</li>
				</ul>
				<li>Detect Tiredness.</li>
				<ul>
					<li>Everytime a new image is received, a rolling average of the previous images is used to see if a negative trend is occurring.</li>
					<li>Will trigger a recommendation to the user to take a break and switch work positions.</li>
				</ul>
				<li>Interval recommendation to switch work positions.</li>
				<ul>
					<li>If the user has been sitting or standing for more than 30 minutes straight, a recommendation to switch will be sent.</li>
				</ul>
			</ul>,
		authors: [TEAM_MEMBER_NAME.DANIEL],
	...
	},
	{
		...
		subsystems: [SUBSYSTEM.FRONT_END, SUBSYSTEM.BACK_END, SUBSYSTEM.CONTROLS, SUBSYSTEM.ELECTRICAL],
	},
	{
		...
		summary:
			<ul>
				...
				<ul>
					...
					<ul>
						<li>Cause might be not enough torque or not enough current/voltage supplied to the motor.</li>
					</ul>
				</ul>
			</ul>,
		authors: [TEAM_MEMBER_NAME.JASON],
	...
	},
	{
		...
		summary:
			<ul>
				...
				<ul>
					...
					<ul>
						<li>Peak current allowed from the driver is not enough to power.</li>
					</ul>
		...
		subsystems: [SUBSYSTEM.MECHANICAL, SUBSYSTEM.CONTROLS, SUBSYSTEM.ELECTRICAL],
	},
	{
		title: BLOG_TITLE.COUPLER_ITER,
		summary:
			<ul>
				<li>Motor is able to lift the table, but the coupler wore out after continuous usage.</li>
				...
				<ul>
					...
					<ul>
						...
						<ul>
							<li>Soft mold, due to the fact that they cannot withstand high pressure forces</li>
							<li>We abandoned the use of the key because the amount of friction it provided was enough to rotate with the motor shaft</li>
							<li>As a result of continuous testing, the coupler wore out, thus eliminating the friction needed to lift the table</li>
						</ul>
					</ul>
					<li>2nd Coupler:</li>
					<ul>
						...
						<ul>
							<li>High-impact thermoplastic ideal for functional prototyping, tooling and low-volume manufacturing</li>
							<li>We also re-incorporated the use of the key with the help of design changes</li>
							<li>Unfortunately, we underestimated the friction force required to lower the table</li>
						</ul>
					</ul>
				</ul>
			</ul>,
	...
	},
	{
		...
		summary:
			<ul>
				<li>Designed new coupler with M4 screw holes to allow for greater friction with the motor shaft as well as the key.</li>
			</ul>,
		authors: [TEAM_MEMBER_NAME.JASON],
	...
	},
	{
		...
		summary:
			<ul>
				<li>Bought custom-designed table top for the table with logo from Vistaprint.</li>
			</ul>,
		authors: [TEAM_MEMBER_NAME.JASON],
	...
	},
	{
		...
		summary:
			<ul>
				...
				<li>New coupler provides enough friction to raise the table, but still not providing enough friction to lower the table.</li>
				<li>Hypothesized that the motor doesn’t have enough torque to lower the table.</li>
				<ul>
	...
	},
	{
		...
		summary:
			<ul>
				<li>Designed a new coupler with M4 screw holes for the new NEMA 34 stepper motor to be 3D printed by Alec.</li>
			</ul>,
		authors: [TEAM_MEMBER_NAME.JASON],
	...
	},
	{
		...
		summary:
			<ul>
				<li>Designed an add-on motor mount with M5 screw holes for the new NEMA 34 stepper motor to be 3D printed by Alec.</li>
			</ul>,
		authors: [TEAM_MEMBER_NAME.JASON],
	...
	},
	{
		...
		subsystems: [SUBSYSTEM.MECHANICAL, SUBSYSTEM.CONTROLS, SUBSYSTEM.BACK_END, SUBSYSTEM.ELECTRICAL, SUBSYSTEM.FRONT_END, SUBSYSTEM.IMAGE_PROCESSING],
	},
];
